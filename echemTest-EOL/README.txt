...
EOL-Esami On Line is a simple and innovative Online Assessment System
based on HTML5, CSS2/3, PHP5 and Ajax
...
ECHEMTEST
PULL DOWN LIST
XML -> PHP converter (utils)
XML -> JS converter (utils)
PHP -> XML converter (utils)
DB UPDATED
and MORE!
...
Support and Help:
   Please use support Issues at https://github.com/EOL-EsamiOnLine/EOL
